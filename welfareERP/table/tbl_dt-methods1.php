                ...
                <div class="d-flex align-items-center">
                  ...
                  <div style="text-align: right;">
                    <select class="form-select" style="width: auto; padding: 0.5rem 2rem 0.5rem 0.5rem; border-radius: 5px; border: 1px solid #ced4da;" onchange="window.location.href=this.value">
                      ...
                      <option value="../table/tbl_dt-methods1.php" selected>거절지원</option>
...
and a.application_id = asd.application_id and asd.state = 'no'"; // your_table_name은 데이터를 가져올 테이블 이름
$result = $conn->query($sql);
    ...
    ?>
              ...
              <div class="button-container text-end"> <!-- 버튼 컨테이너 추가, 오른쪽 정렬 -->
                ...
                <button type="button" class="btn btn-sm btn-light-danger main" id="delete">거절</button>
              </div>
    ...
    function init() {
      ...
      $('#delete').click(function() {
        ...
        if (selectedNames.length > 0) {
          ...
          $.post('../dashboard/php/delete.php', {selectedNames: selectedNames});
